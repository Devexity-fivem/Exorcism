...
local function normalize_corners(corners)
  local corners = table.move(corners, 1, 4, 1, {})
...
local function forms_rectangle(corners, grid)
  local c = normalize_corners(corners)
  return
    vertical_line_connecting(c[1], c[2], grid) and
    vertical_line_connecting(c[3], c[4], grid) and
    horizontal_line_connecting(c[1], c[3], grid) and
    horizontal_line_connecting(c[2], c[4], grid)
end
